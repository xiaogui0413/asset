...
<div id="MainArea">
    <table class="MainArea_Content" cellspacing="0" cellpadding="0">
		...
		<c:choose>
			<c:when test="${not empty requestScope.listAssets }">
				<c:forEach var="Assets" items="${pb.beanList }">
				
			<tr class="TableDetail1">
				<td align="center">${Assets.id }</td>
   ...
   <!-- 其他功能超链接 -->
	<div id="TableTail" align="center">
		<div class="FunctionButton"><a href="${pageContext.request.contextPath }/detail/saveAssetsWH.jsp">添加</a></div>
		    	<div align="right">
		当前${requestScope.page.pageNum }/${pb.tp }页 &nbsp;
		<a title="首页" href="${pageContext.request.contextPath }/detail/wuhan.jsp?currentPage=1">首页</a>&nbsp;
		<a title="上一页" href="${pageContext.request.contextPath}${page.uri}&num=${page.prePageNum}">上一页</a>&nbsp;
		
		<a title="下一页" href="${pb.url }&pc=${pb.pc+1}">下一页</a>&nbsp;
		<a title="末页" href="${pageContext.request.contextPath }/detail/wuhan.jsp?currentPage=${requestScope.pageBean.totalPage}">末页</a>&nbsp;
		共条数据&nbsp;&nbsp;
		</div>
    </div> 
