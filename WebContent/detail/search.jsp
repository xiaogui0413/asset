...
<!-- 过滤条件 -->
<div id="QueryArea">
	<form action="${pageContext.request.contextPath }/AssetsServlet?method=findByPage2" method="post">
...
<div id="MainArea">
   ...
   <!-- 其他功能超链接 -->
	<div id="TableTail" align="center">
		...
		<a title="首页" href="${pageContext.request.contextPath }/AssetsServlet?method=findByPage2&currentPage=1">首页</a>&nbsp;
		<a title="上一页" href="${pageContext.request.contextPath }/AssetsServlet?method=findByPage2&currentPage=${requestScope.pageBean.currentPage-1 }">上一页</a>&nbsp;
		
		<a title="下一页" href="${pageContext.request.contextPath }/AssetsServlet?method=findByPage2&currentPage=${requestScope.pageBean.currentPage+1 }">下一页</a>&nbsp;
		<a title="末页" href="${pageContext.request.contextPath }/AssetsServlet?method=findByPage2&currentPage=${requestScope.pageBean.totalPage }">末页</a>&nbsp;
