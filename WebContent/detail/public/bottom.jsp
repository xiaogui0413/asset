...
<div id="StatusBar">
    ...
    <span style="font-family:arial;">版本1.0 | 版权所有&copy; 2016 - 陕西西普数据通信股份有限公司，保留所有权利。</span>	
    </div>
	<!-- 右侧功能按钮 -->
    <div id="StatusBar_Right">
		<!-- 版本 -->
		<a href="javascript:void(0)">
			<img border="0" width="11" height="11" src="${pageContext.request.contextPath }/detail/style/images/info.gif" /> 
			<img border="0" width="40" height="11" src="${pageContext.request.contextPath }/detail/style/images/version.gif" />
		</a>
    </div>
</div>
